...
#define KOR_COMPILER_HEADER(name) KOR_PP_STRINGIFY_EXPAND(KOR_COMPILER_NAME/KOR_PP_CONCAT_EXPAND(KOR_COMPILER_NAME, name.h))
#define KOR_COMPILER_HEADER_FROM(root, name) KOR_PP_STRINGIFY_EXPAND(root/KOR_COMPILER_NAME/KOR_PP_CONCAT_EXPAND(KOR_COMPILER_NAME, name.h))
